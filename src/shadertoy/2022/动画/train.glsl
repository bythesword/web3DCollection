#iChannel0 "file://train.noise.png"
float noise(vec2 x) {
    vec2 f = fract(x);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    h = (fbm(uv2, 8) - 0.5) * disp;
    if(uv.y < h + midlevel)
        col = vec3(0.74, 0.35, 0.30);
    if(uv.y < h + midlevel - 0.05)
        col = vec3(0.60, 0.30, 0.27);
    if(uv.y < h + midlevel - 0.1)
        col = vec3(0.56, 0.25, 0.22);
    ...
    h = (fbm(uv2, 8) - 0.5) * disp;
    if(uv.y < h + midlevel)
        col = vec3(1.0, 0.76, 0.60);
    if(uv.y < h + midlevel - 0.1)
        col = vec3(0.93, 0.58, 0.35);
    ...
    h = (fbm(uv2, 8) - 0.5) * disp;
    if(uv.y < h + midlevel)
        col = vec3(0.80, 0.40, 0.34);
    if(uv.y < h + midlevel - 0.04)
        col = vec3(0.73, 0.36, 0.30);
    ...
    h = (fbm(uv2, 8) - 0.5) * disp;
    if(uv.y < h + midlevel)
        col = vec3(1.0, 0.62, 0.44);
    if(uv.y < h + midlevel - 0.1)
        col = vec3(0.90, 0.55, 0.40);
    if(uv.y < h + midlevel - 0.15)
        col = vec3(0.98, 0.50, 0.24);
    if(uv.y < h + midlevel - 0.2)
        col = vec3(1.0, 0.55, 0.33);
    ...
    h = (fbm(uv2, 8) - 0.5) * disp;
    if(uv.y < h + midlevel)
        col = vec3(1.0, 0.48, 0.35);
    if(uv.y < h + midlevel - 0.05)
        col = vec3(0.98, 0.42, 0.28);
    if(uv.y < h + midlevel - 0.1)
        col = vec3(0.88, 0.38, 0.24);
    ...
    h = (fbm(uv2, 8) - 0.5) * disp;
    if(uv.y < h + midlevel)
        col = vec3(0.99, 0.29, 0.20);
    if(uv.y < h + midlevel - 0.04)
        col = vec3(0.80, 0.24, 0.17);
    if(uv.y < h + midlevel - 0.08)
        col = vec3(0.53, 0.35, 0.32);
    if(uv.y < h + midlevel - 0.12)
        col = vec3(0.41, 0.27, 0.27);
    ...
    h = (fbm(uv2, 8) - 0.5) * disp;
    if(uv.y < h + midlevel)
        col = vec3(0.77, 0.48, 0.46);
    if(uv.y < h + midlevel - 0.04)
        col = vec3(0.66, 0.42, 0.40);
    if(uv.y < h + midlevel - 0.08)
        col = vec3(0.55, 0.42, 0.41);
    if(uv.y < h + midlevel - 0.12)
        col = vec3(0.43, 0.32, 0.31);
    ...
    h = (fbm(uv2, 8) - 0.5) * disp;
    if(uv.y < h + midlevel)
        col = vec3(0.95, 0.80, 0.77);
    if(uv.y < h + midlevel - 0.04)
        col = vec3(0.98, 0.76, 0.64);
    ...
    h = (fbm(uv2, 8) - 0.5) * disp;
    if(uv.y < h + midlevel)
        col = vec3(0.95, 0.45, 0.30);
    if(uv.y < h + midlevel - 0.07)
        col = vec3(0.88, 0.38, 0.24);
    if(uv.y < h + midlevel - 0.1)
        col = vec3(0.68, 0.28, 0.19);
    if(uv.y < h + midlevel - 0.14)
        col = vec3(0.48, 0.19, 0.20);
